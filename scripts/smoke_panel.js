...
setTimeout(async () => {
  ...
  checks.push(
    ...
    ["settings: routine-learning opt-in card (doors/presence + add entities)", (() => { const h = el._renderRoutineLearning(el._data()); return /data-cfg-key="pattern_learn_doors"/.test(h) && /data-cfg-key="pattern_learn_presence"/.test(h) && /id="pl-add-entity"/.test(h); })()],
