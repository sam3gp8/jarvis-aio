...
setTimeout(async () => {
  ...
  checks.push(
    ...
    ["floor editor: place windows/doors + map to a sensor", (() => { const h = el._renderOpenings("1f"); return /id="op-add-window"/.test(h) && /id="op-add-extdoor"/.test(h) && /id="op-add-intdoor"/.test(h); })()],
